  ...
  if (topbarTools) {
    const searchItems = isEnglish
      ? [
          ...
          ["Method", "How I learn and verify", "education.html", "education study steps process"],
          ["Study", "Topics and connections", "courses.html", "408 mathematics vision"],
          ["Results", "Completed work and deliverables", "achievements.html", "achievements results milestones"],
      ...
      : [
          ...
          ["方法", "我怎样学习和验证", "education.html", "学习 步骤 推导"],
          ["学习", "学习内容与知识联系", "courses.html", "408 数学 图像复原"],
          ["成果", "已经完成的工作与文档", "achievements.html", "结果 文档"],
