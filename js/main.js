  ...
  if (topbarTools) {
    const searchItems = isEnglish
      ? [
          ...
          ["Conclusions & limits", "Current evidence and open evaluation", "projects.html#limits", "scope baseline benchmark"],
          ["Method", "From model to evidence", "education.html", "model derive test evaluate"],
          ["Study", "Mechanisms and technical connections", "courses.html", "408 mathematics restoration"],
          ["Cross-topic links", "Systems, I/O, and restoration", "courses.html#connections", "cache dma fft optimization"],
          ["Results", "Implementations, checkpoints, and metrics", "achievements.html", "evidence weights metrics"],
      ...
      : [
          ...
          ["结论与边界", "现有证据与待补评测", "projects.html#limits", "范围 基线 对比"],
          ["方法", "从模型到证据", "education.html", "建模 推导 测试 评测"],
          ["学习", "机制与技术联系", "courses.html", "408 数学 图像复原"],
          ["跨主题联系", "存储、I/O 与图像复原", "courses.html#connections", "cache dma fft 优化"],
          ["成果", "实现、权重与实验数值", "achievements.html", "证据 权重 指标"],
